  ...
  return {
    ...
    closeBundle() {
      ...
      copy(
        ...
        "dist/vendor/tesseract/worker.min.js",
      );
      for (const f of [
      ...
      copy(
        ...
        "dist/models/tesseract/eng.traineddata.gz",
      );
      copy(
        "node_modules/@tesseract.js-data/kor/4.0.0_best_int/kor.traineddata.gz",
        "dist/models/tesseract/kor.traineddata.gz",
      );
      copy(
        "node_modules/@tesseract.js-data/jpn/4.0.0_best_int/jpn.traineddata.gz",
        "dist/models/tesseract/jpn.traineddata.gz",
      );
      copy(
        "node_modules/@tesseract.js-data/jpn_vert/4.0.0_best_int/jpn_vert.traineddata.gz",
        "dist/models/tesseract/jpn_vert.traineddata.gz",
      );
      copy(
        "node_modules/@tesseract.js-data/chi_sim/4.0.0_best_int/chi_sim.traineddata.gz",
        "dist/models/tesseract/chi_sim.traineddata.gz",
      );
    },
  };
}
